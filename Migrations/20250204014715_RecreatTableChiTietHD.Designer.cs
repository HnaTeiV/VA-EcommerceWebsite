...
namespace VA_EcommerceWebsite.Migrations
{
    ...
    [Migration("20250204014715_RecreatTableChiTietHD")]
    partial class RecreatTableChiTietHD
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VA_EcommerceWebsite.Data.NhanVien", b =>
                {
                    ...
                    b.HasKey("MaNv")
                        .HasName("PK__NhanVien__2725D70A7C859924");

                    b.HasIndex("MaPb");

                    b.HasIndex(new[] { "Email" }, "UQ__NhanVien__A9D10534C841FFF4")
                        .IsUnique();
            ...
            modelBuilder.Entity("VA_EcommerceWebsite.Data.PhongBan", b =>
                {
                    ...
                    b.HasKey("MaPb")
                        .HasName("PK__PhongBan__2725E7E4CCF35283");
            ...
            modelBuilder.Entity("VA_EcommerceWebsite.Data.YeuThich", b =>
                {
                    ...
                    b.HasKey("MaYt")
                        .HasName("PK__YeuThich__272330F4DD30EEDD");
