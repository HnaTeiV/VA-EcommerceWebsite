...
namespace VA_EcommerceWebsite.Controllers
{
    ...
    {
        private readonly VAEcommerceContext _context;

        public HangHoaController(VAEcommerceContext context)
        {
            _context = context;
        }
        ...
        {
            var vAEcommerceContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await vAEcommerceContext.ToListAsync());
        }
